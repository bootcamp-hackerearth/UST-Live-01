...
namespace HealthCare_Appointment_Portal.Controllers
{
    ...
    public class AppointmentController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetAppointmentsByPatient(int patientId)
        {
            var appointments =
        ...
        public async Task<IHttpActionResult> GetNextAppointment(int patientId)
        {
            var appointment =
                await _appointmentService.GetNextAppointmentByPatientAsync(patientId);
        ...
        public async Task<IHttpActionResult> GetAppointmentsByDoctor(int doctorId)
        {
            var appointments =
                await _appointmentService.GetAppointmentsByDoctorAsync(doctorId);
        ...
        public async Task<IHttpActionResult> GetTodaySchedule(int doctorId)
        {
            var appointments =
        ...
        public async Task<IHttpActionResult> GetWeeklySchedule(int doctorId)
        {
            var appointments =
        ...
        [HttpPost]
        [Route("")]
        public async Task<IHttpActionResult> AddAppointment(
        ...
        public async Task<IHttpActionResult> ConfirmAppointment(int id)
        {
            try
            {
        ...
        public async Task<IHttpActionResult> CompleteAppointment(int id)
        {
            try
            {
