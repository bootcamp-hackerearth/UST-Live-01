...
namespace HealthAxis.API.Utilities
{
    ...
    public static class Helpers
    {
        ...
        public const string DateOfBirthCannotBeBefore1900 =
            "Date Of Birth cannot be before 01-Jan-1900.";

        public const string InvalidDateOfBirthRange =
            "Date Of Birth must be between 01-Jan-1900 and today's date.";
        ...
        public const string InvalidStrictEmailFormat =
            "Email must be in a valid format, for example name@example.com.";
        ...
        public const string ProviderNameRequired =
            "Provider Name is required.";

        public const string PolicyNumberRequired =
            "Policy Number is required.";

        public const string ExpiryDateRequired =
            "Expiry Date is required.";

        public const string InsuranceStatusRequired =
            "Insurance Status is required.";

        public const string PasswordRequired =
            "Password is required.";

        public const string UserRoleRequired =
            "User Role is required.";

        public const string ReferenceIdRequired =
        ...
        public const string PolicyNumberAlreadyExists =
            "Policy Number already exists.";

        public const string TimeSlotAlreadyBooked =
        ...
        public const string DoctorInactive =
            "Appointment cannot be booked with an inactive doctor.";

        public const string PastDateNotAllowed =
        ...
        public const string DoctorRemovedFromSystem =
            "Doctor removed from system.";

        public const string PatientRemovedFromSystem =
        ...
        public const string ConfirmOnlyScheduled =
            "Only scheduled appointments can be confirmed.";

        public const string CancelOnlyScheduled =
