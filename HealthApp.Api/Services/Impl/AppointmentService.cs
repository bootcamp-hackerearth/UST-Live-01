...
namespace HealthApp.Api.Services.Impl
{
    public class AppointmentService : IAppointmentService
    {
            ...
            AppointmentCreateDto dto)
        {
            ...
            await EnsureDoctorIsNotOnLeaveAsync(dto, scheduledDate);
            ...
            var createdAppointment =
                await CreateAppointmentWithOutboxAsync(
                    dto,
                    scheduledDate,
                    slot,
                    patient,
        ...
        private async Task<Appointment> CreateAppointmentWithOutboxAsync(
            AppointmentCreateDto dto,
            ...
            string patientUserId)
        {
            ...
            try
            {
                ...
                var eventId = await _outboxService
                    .EnqueueAppointmentBookedAsync(
                        appointmentBookedEvent);

                await transaction.CommitAsync();

                LogAppointmentOutboxMessageCreated(
        ...
        private void LogAppointmentOutboxMessageCreated(
            int appointmentId,
            Guid eventId)
        {
            if (!_logger.IsEnabled(LogLevel.Information))
            ...
            _logger.LogInformation(
                "Appointment-booked event {OutboxEventId} was stored in the outbox for appointment {AppointmentId}. Event type: {EventType}",
                eventId,
                appointmentId,
                "AppointmentBookedOutboxMessageCreated");
        }
