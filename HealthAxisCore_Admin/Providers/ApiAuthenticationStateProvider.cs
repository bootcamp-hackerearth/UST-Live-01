...
public class ApiAuthenticationStateProvider : AuthenticationStateProvider
{
    ...
    private static void AddRoleClaimIfNeeded(List<Claim> claims)
    {
        var roleClaim = claims.FirstOrDefault(claim =>
        ...
        var alreadyMapped = claims.Any(claim =>
            claim.Type == ClaimTypes.Role &&
    ...
    private static void AddUserIdClaimIfNeeded(List<Claim> claims)
    {
    ...
    private static void AddEmailClaimIfNeeded(List<Claim> claims)
    {
