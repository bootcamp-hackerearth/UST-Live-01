...
namespace HealthAxisApplicn.Repositories
{
    ...
    {
        Task<List<Appointment>> GetAppointmentsByPatientIdAsync(int patientId, int page, int pageSize, CancellationToken ct = default);
        Task<List<Appointment>> GetUpcomingAppointmentsByDoctorIdAsync(int doctorId, int page, int pageSize, CancellationToken ct = default);
        ...
        Task<List<Appointment>> GetTodayAppointmentsAsync(int doctorId, int page, int pageSize, CancellationToken ct = default);
        Task<List<Appointment>> GetAllAppointmentsAsync(int page, int pageSize);
