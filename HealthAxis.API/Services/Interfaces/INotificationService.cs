...
namespace HealthAxis.API.Services.Interfaces
{
    ...
    {
        Task<bool> CreateAppointmentBookedNotificationAsync(
            AppointmentBookedEvent appointmentBookedEvent,
            CancellationToken cancellationToken = default);

        Task<List<NotificationDto>> GetPatientNotificationsAsync(
            int patientId,
            CancellationToken cancellationToken = default);

        Task<List<NotificationDto>> GetDoctorNotificationsAsync(
            int doctorId,
            CancellationToken cancellationToken = default);
        ...
        Task<int> MarkAllPatientNotificationsAsReadAsync(
            int patientId,
            CancellationToken cancellationToken = default);

        Task<int> MarkAllDoctorNotificationsAsReadAsync(
            int doctorId,
            CancellationToken cancellationToken = default);
    }
}