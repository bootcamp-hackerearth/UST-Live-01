...
namespace HealthAxis.DTOs.PatientDtos
{
    public class CreatePatientDto
    {
        [Required(
            ErrorMessage = ValidationMessages.FullNameRequired)]
        [StringLength(
        ...
        [Required(
            ErrorMessage = ValidationMessages.DateOfBirthRequired)]
        [DataType(
            DataType.Date)]
        [CustomValidation(
        ...
        [Required(
            ErrorMessage = ValidationMessages.GenderRequired)]
        ...
        [Required(
            ErrorMessage = ValidationMessages.PhoneNumberRequired)]
        [StringLength(
