...
namespace HealthAxis.API.Migrations
{
    ...
    [Migration("20260720114854_AddNotificationIdempotency")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthAxis.API.Models.Appointment", b =>
                {
                    ...
                    b.HasIndex("DoctorId", "ScheduledDate", "TimeSlot")
                        .IsUnique()
                        .HasDatabaseName("UX_Appointments_Doctor_Slot_Active")
                        .HasFilter("[Status] IN ('Pending', 'Confirmed')");

                    b.HasIndex("PatientId", "ScheduledDate", "TimeSlot")
                        .IsUnique()
                        .HasDatabaseName("UX_Appointments_Patient_Slot_Active")
                        .HasFilter("[Status] IN ('Pending', 'Confirmed')");
            ...
            modelBuilder.Entity("HealthAxis.API.Models.Notification", b =>
                {
                    ...
                    b.HasIndex("AppointmentId", "DoctorId", "NotificationType")
                        .IsUnique()
                        .HasDatabaseName("UX_Notifications_Appointment_Doctor_Type")
                        .HasFilter("[AppointmentId] IS NOT NULL AND [DoctorId] IS NOT NULL");
